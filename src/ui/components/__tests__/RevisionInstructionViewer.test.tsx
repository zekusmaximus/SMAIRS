...
const mockManuscript = `Chapter 1

The detective walked slowly down the street. It was a dark and stormy night when the phone rang.

Chapter 2

The door opened and revealed the mystery.`;
...
describe('RevisionInstructionViewer', () => {
  ...
  describe('View Mode Switching', () => {
    ...
    it('switches to print view', async () => {
      ...
      const printViewButton = screen.getByRole('button', { name: /print/i });
  ...
  describe('Context Panel', () => {
    ...
    it('highlights target text in context', () => {
      ...
      const highlightedText = screen.getByText('slowly');
  ...
  describe('Performance', () => {
    ...
    it('efficiently filters large instruction sets', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/100 instructions/)).toBeInTheDocument(); // 100 matches expected
      });
    });
  });
});